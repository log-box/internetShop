...
@register.filter(name='media_folder_users') # один варинат регистрации тега
...
register.filter('media_folder_products', media_folder_products) # другой вариант регистрации тега
